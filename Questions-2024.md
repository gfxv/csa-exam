...
Принципы совместного проектирование (HW/SW CoDesign)
- *Совместная разработка*
	- *ПО и АО разработаны совместно => оптимальная совместимость и производительность*
- Разработка системы команд (интерфейса) HW/SW
- Использование моделей HW/SW
- Разработка HW/SW
- Интеграция
